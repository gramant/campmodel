;(function(omidGlobal, factory, exports) {
    ...
    var module$exports$omid$common$version = {ApiVersion:"1.0", Version:"1.3.13-dev"};
...
(function(){
    const omidClient = new module$exports$omid$verificationClient$VerificationClient();
    if (omidClient.isSupported()) {
        console.log("OMID supported!");
    }
})();