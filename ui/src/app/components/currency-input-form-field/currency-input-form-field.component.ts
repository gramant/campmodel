...
@Component({
  selector: 'app-currency-input-form-field',
  templateUrl: './currency-input-form-field.component.html',
  styleUrls: ['./currency-input-form-field.component.scss'],
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => CurrencyInputFormFieldComponent),
            multi: true,
        }
    ]
})
export class CurrencyInputFormFieldComponent implements OnInit, OnChanges, ControlValueAccessor {
