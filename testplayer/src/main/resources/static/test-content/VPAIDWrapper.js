VPAIDWrapper = function(VPAIDCreative) {
  ...
  if (!this.checkVPAIDInterface(VPAIDCreative)) {
    ...
    console.error('VPAIDWrapper; VPAID JS not to spec');
    return;
  }
  console.log('VPAIDWrapper; Verified good VPAID JS');
 ...
 */
VPAIDWrapper.prototype.initAd = function (width,
                                          height,
                                          viewMode,
                                          desiredBitrate,
                                          creativeData,
